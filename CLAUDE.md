...
Keep only Claude-specific overrides in this file. When general repo guidance changes, update `docs/AGENT_GUIDE.md` instead of duplicating content here — the bullets above are deliberate, high-cost exceptions kept loud at the entrypoint, not a license to copy the guide.
